...
// Function to show creators page
...
// Always show cover page on load (removed sessionStorage check)
...
// ==================== CONSOLE MESSAGE ====================
console.log('%c🏋️ Empire Fitness', 'color: #ff0050; font-size: 24px; font-weight: bold;');
console.log('%cTransforma tu cuerpo, fortalece tu mente 💪', 'color: #00d4ff; font-size: 16px;');
console.log('%c¿Interesado en trabajar con nosotros? Envía tu CV a: careers@empirefitness.com', 'color: #7f00ff; font-size: 12px;');
...
console.log('✓ Empire Fitness - Website Loaded Successfully!');
